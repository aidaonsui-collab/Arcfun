...
Ship yes is in. Both factories share the new `Split`. The label stays fee.

Deployed together on 2026-09-23. The previous hook and factories stay in the catalog so existing tokens keep trading.
