...
export function Atmosphere() {
  return (
    <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden" aria-hidden>
      <div className="absolute inset-x-0 -top-24 h-[420px] bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgb(47_132_219_/_0.2),transparent_70%)]" />
      <div className="absolute -right-24 top-[12%] size-[520px] rounded-full bg-[radial-gradient(circle,rgb(59_142_239_/_0.12),transparent_68%)]" />
      <div className="absolute -left-32 bottom-[8%] size-[380px] rounded-full bg-[radial-gradient(circle,rgb(124_255_58_/_0.05),transparent_70%)]" />
      ...
      >
        <g className="origin-center quote-orbit" style={{ transformOrigin: '400px 300px' }}>
          ...
          <ellipse
            ...
            rx="270"
            ry="118"
            stroke="rgba(124,255,58,0.1)"
            strokeWidth="1"
            strokeDasharray="16 14"
          />
        </g>
        <g className="origin-center quote-orbit-rev" style={{ transformOrigin: '400px 300px' }}>
          <ellipse cx="400" cy="300" rx="200" ry="88" stroke="rgba(126,192,247,0.2)" strokeWidth="1.1" />
          <ellipse cx="400" cy="300" rx="140" ry="60" stroke="rgba(59,142,239,0.14)" strokeDasharray="2 8" />
        </g>
        {STARS.map((s) => (
