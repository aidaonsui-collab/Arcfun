...
export const PORT_NFT_ABI = [
  ...
  { type: 'function', name: 'allowlistMintStart', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint64' }] },
  { type: 'function', name: 'allowlistMintEnd', stateMutability: 'view', inputs: [], outputs: [{ type: 'uint64' }] },
  ...
  },
  {
    ...
    stateMutability: 'nonpayable',
    inputs: [
      { name: 'publicStart', type: 'uint64' },
      { name: 'allowlistStart', type: 'uint64' },
      { name: 'allowlistEnd', type: 'uint64' },
    ],
    outputs: [],
  },
  {
